  ...
  return (
    <main className="bg-white ">
      ...
      <section className="mb-4 px-4">
        ...
        <div className="max-w-3-4xl mx-auto space-y-8 font-proxima">
          <div className="flex items-center py-4 bg-grey3 border border-green1 rounded-xl"> 
            <p className="w-1/4 text-green2 font-bold text-center text-md">Downtown<br />SLC</p>
            <div className="w-2/4 text-green1 text-left min-w-[200px]">
              <p className="font-extrabold leading-tight md:text-2xl md:leading-tight">
                  Tuesday, October 3<sup>rd</sup> 2023
              </p>
              <p className="text-green2 font-semibold text-base leading-tight md:text-lg md:leading-tight">9:00 am – 2:00 pm</p>
              <p className="text-green2 font-semibold text-base leading-tight md:text-lg md:leading-tight">New Patients and Renewals</p>
            </div>
            <div className="w-1/4 flex justify-center shrink-0">
              <button className="bg-tan2 px-2 py-1 md:px-6 md:py-2 rounded-full">
                <p className="text-green2 font-semibold md:text-lg">Book Time</p>
              </button>
            </div>
          </div>
          <div className="flex items-center py-4 bg-grey3 border border-green1 rounded-xl"> 
            <p className="w-1/4 text-green2 font-bold text-center text-md">Price UT</p>
            <div className="w-2/4 text-green1 text-left min-w-[200px]">
              <p className="font-extrabold leading-tight md:text-2xl md:leading-tight">
                  Thursday, October 19<sup>th</sup> 2023
              </p>
              <p className="text-green2 font-semibold text-base leading-tight md:text-lg md:leading-tight">9:00 am – 4:00 pm</p>
              <p className="text-green2 font-semibold text-base leading-tight md:text-lg md:leading-tight">Renewals Only</p>
            </div>
            <div className="w-1/4 flex justify-center shrink-0">
              <button className="bg-tan2 px-2 py-1 md:px-6 md:py-2 rounded-full">
                <p className="text-green2 font-semibold md:text-lg">Book Time</p>
          ...
          <div className="flex items-center py-4 bg-grey3 border border-green1 rounded-xl"> 
            <p className="w-1/4 text-green2 font-bold text-center text-md">&lt;Other Location&gt;</p>
            <div className="w-2/4 text-green1 text-left min-w-[200px]">
              <p className="font-extrabold leading-tight md:text-2xl md:leading-tight">
                  Friday, November 10<sup>th</sup> 2023
              </p>
              <p className="text-green2 font-semibold text-base leading-tight md:text-lg md:leading-tight">10:00 am – 2:00 pm</p>
              <p className="text-green2 font-semibold text-base leading-tight md:text-lg md:leading-tight">Special Event for Veterans</p>
            </div>
            <div className="w-1/4 flex justify-center shrink-0">
              <button className="bg-tan2 text-green2 px-2 py-1 md:px-6 md:py-2 rounded-full">
                <p className="text-green2 font-semibold md:text-lg">Book Time</p>
              </button>
            </div>
          </div>
      ...
      <section className="mb-4 py-8 px-4">
        ...
        <div className="max-w-3-4xl mx-auto space-y-8 text-green1 font-semibold font-proxima">
          ...
          <div className="relative w-full h-auto">
            ...
            <div className="absolute top-0 left-0 w-full h-full flex items-center px-8">
              <div className="text-white max-w-sm">
                ...
                <button className="bg-tan2 text-green2 font-semibold px-2 py-1 md:px-6 md:py-2 rounded-full md:text-xl">
                  Review us here!
                </button>
              </div>
            </div>
      ...
      <section className="mb-4 py-8 px-4">
        <div className="max-w-3-4xl mx-auto space-y-4 font-proxima">
          ...
          <ul className="space-y-2 md:space-y-1 text-green2 font-semibold text-sm md:text-lg">
          ...
          <div className="space-y-4">
            <div className="flex flex-col md:flex-row">
              <div className="md:w-[45%]">
                ...
                <button className="bg-tan2 text-green1 font-semibold px-4 py-1 mt-2 rounded-full text-sm">
      ...
      <section className="relative px-4 mb-8 md:mb-0">
        <div className="max-w-3-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 font-proxima">
          ...
          <div className="absolute bottom-[15px] md:bottom-[25px] left-0 w-full h-[2px] bg-green1" />
        </div>  
      </section>
      <Footer />
    </main>
